...
export class ServicesServices {
    ...
    getServiceOperation(operationIRI: IRI): Observable<any> {
        let params = {
    ...
    getServiceOperationAsCustomService(operationIRI: IRI): Observable<Operation> {
        let params = {
            operationIRI: operationIRI,
        };
    ...
    getServiceInvocationForm(operationIRI: IRI): Observable<any> {
        let params = {
            operationIRI: operationIRI,
        };
