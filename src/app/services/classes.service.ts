...
export class ClassesServices {
     ...
     * @param classList
     */
    getClassesInfo(classList: IRI[], options?: PMKIRequestOptions): Observable<AnnotatedValue<IRI>[]> {
        var params: any = {
            classList: classList
        };
	 ...
	 */
    getSubClasses(superClass: IRI, numInst: boolean, options?: PMKIRequestOptions): Observable<AnnotatedValue<IRI>[]> {
        var params: any = {
	 ...
	 * @param cls
     */
    getInstances(cls: IRI, options?: PMKIRequestOptions): Observable<AnnotatedValue<Resource>[]> {
        var params: any = {
            cls: cls
        };
     ...
     * @param cls 
     */
    getNumberOfInstances(cls: IRI, options?: PMKIRequestOptions): Observable<number> {
        var params: any = {
            cls: cls
        };
