...
import { ServicesServices } from 'src/app/services/services.service';
...
@Component({
    ...
    templateUrl: "./service-invocation-editor-modal.html",
...
export class ServiceInvocationEditorModal {
    ...
    constructor(private customServService: CustomServiceServices, private servicesService: ServicesServices, private invokableReporterService: InvokableReportersServices,
        private basicModals: BasicModalsServices, private customServiceModals: CustomServiceModalServices,
    ...
    selectOperation(operationId: string): Observable<void> {
        if (this.selectedOperationId == operationId) {
            ...
            if (this.selectedExtPath == this.CUSTOM_SERVICE_PATH) {
                ...
                this.servicesService.getServiceOperation(new IRI(operationId)).subscribe();
                return this.servicesService.getServiceOperationAsCustomService(new IRI(operationId)).pipe(
