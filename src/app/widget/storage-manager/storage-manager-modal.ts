...
@Component({
    ...
    templateUrl: "./storage-manager-modal.html",
})
export class StorageManagerModal {
    ...
    constructor(public activeModal: NgbActiveModal, private storageServices: StorageServices, private basicModals: BasicModalsServices) {
    }
