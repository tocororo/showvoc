...
import { RDFResourceRolesEnum, Value } from 'src/app/models/Resources';
import { SettingsPropType, SettingsPropTypeConstraint } from '../../models/Plugins';

@Component({
    selector: 'setting-set',
    templateUrl: './setting-set-renderer.component.html',
})
export class SettingSetRendererComponent {
    ...
    private updateValue(index: number, value: Value) {
        if (value == null) {
