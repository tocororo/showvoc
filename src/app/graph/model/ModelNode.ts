import { AnnotatedValue, RDFResourceRolesEnum, Resource, Value } from 'src/app/models/Resources';
...
export class ModelNode extends Node {
    ...
    initNodeShape() {
         ...
         */
        if (this.res.getValue() instanceof Resource) {
            ...
            if (role == RDFResourceRolesEnum.annotationProperty ||
                ...
                if (this.res.getValue().equals(RDFS.literal)) { //special case
                    this.shape = NodeShape.rect;
                }
    ...
    initNodeMeasure() {
        ...
        if (shape == NodeShape.circle) {
            ...
            if (this.res.getValue().equals(RDFS.literal)) { //rdfs:Literal rect in modelGraph is rendered smaller
