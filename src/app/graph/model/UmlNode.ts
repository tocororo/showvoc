import { AnnotatedValue, IRI, RDFResourceRolesEnum, ResAttribute, Resource, Value } from 'src/app/models/Resources';
...
export class UmlNode extends Node {
    ...
    constructor(res: AnnotatedValue<Value>) {
        super(res);
        this.explicit = res.getAttribute(ResAttribute.EXPLICIT) ||
            res.getAttribute(ResAttribute.EXPLICIT) == undefined;
...
export class PropInfo {
    ...
    range: AnnotatedValue<Resource>;
    show?: string;
    normalizedShow?: string;
    xlink?: string;
    constructor(property: AnnotatedValue<IRI>, range: AnnotatedValue<Resource>) {
        ...
        let explicit: boolean = property.getAttribute(ResAttribute.EXPLICIT) ||
            property.getAttribute(ResAttribute.EXPLICIT) == undefined;
