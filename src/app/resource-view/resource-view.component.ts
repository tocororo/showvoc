...
export class ResourceViewComponent {
    ...
    private fillPartitions() {
        ...
        let broadersPartition: any = this.resViewResponse[ResViewPartition.broaders];
        ...
        let classAxiomsPartition: any = this.resViewResponse[ResViewPartition.classaxioms];
        ...
        let constituentsPartition: any = this.resViewResponse[ResViewPartition.constituents];
        ...
        let denotationsPartition: any = this.resViewResponse[ResViewPartition.denotations];
        ...
        let disjointPropertiesPartition: any = this.resViewResponse[ResViewPartition.disjointProperties];
        ...
        let domainsPartition: any = this.resViewResponse[ResViewPartition.domains];
        ...
        let equivalentPropertiesPartition: any = this.resViewResponse[ResViewPartition.equivalentProperties];
        ...
        let evokedLexicalConceptsPartition: any = this.resViewResponse[ResViewPartition.evokedLexicalConcepts];
        ...
        let facetsPartition: any = this.resViewResponse[ResViewPartition.facets];
        ...
        let formBasedPreviewPartition: any = this.resViewResponse[ResViewPartition.formBasedPreview];
        ...
        let formRepresentationsPartition: any = this.resViewResponse[ResViewPartition.formRepresentations];
        ...
        let importsPartition: any = this.resViewResponse[ResViewPartition.imports];
        ...
        let labelRelationsPartition: any = this.resViewResponse[ResViewPartition.labelRelations];
        ...
        let lexicalizationsPartition: any = this.resViewResponse[ResViewPartition.lexicalizations];
        ...
        let lexicalFormsPartition: any = this.resViewResponse[ResViewPartition.lexicalForms];
        ...
        let lexicalSensesPartition: any = this.resViewResponse[ResViewPartition.lexicalSenses];
        if (lexicalFormsPartition != null) {
        ...
        let membersPartition: any = this.resViewResponse[ResViewPartition.members];
        ...
        let membersOrderedPartition: any = this.resViewResponse[ResViewPartition.membersOrdered];
        if (membersOrderedPartition != null) {
            ...
            for (let i = 0; i < this.membersOrderedColl.length; i++) { //for each pred-obj-list
        ...
        let notesPartition: any = this.resViewResponse[ResViewPartition.notes];
        ...
        let propertiesPartition: any = this.resViewResponse[ResViewPartition.properties];
        ...
        let rangesPartition: any = this.resViewResponse[ResViewPartition.ranges];
        ...
        let rdfsMembersPartition: any = this.resViewResponse[ResViewPartition.rdfsMembers];
        ...
        let schemesPartition: any = this.resViewResponse[ResViewPartition.schemes];
        ...
        let subPropertyChainsPartition: any = this.resViewResponse[ResViewPartition.subPropertyChains];
        ...
        let subtermsPartition: any = this.resViewResponse[ResViewPartition.subterms];
        ...
        let superPropertiesPartition: any = this.resViewResponse[ResViewPartition.superproperties];
        ...
        let topConceptOfPartition: any = this.resViewResponse[ResViewPartition.topconceptof];
        ...
        let typesPartition: any = this.resViewResponse[ResViewPartition.types];
    ...
    private parseFacetsPartition(facetsPartition: any) {
        this.propertyFacets = [];
        for (let facetName in facetsPartition) {
