...
@Component({
    ...
    templateUrl: "./new-dataset-modal.html",
})
export class NewDatasetModal {
     ...
     */
    distributionNatureOpts: { id: DatasetNature, uri: IRI, label: string }[] = [
    ...
    dataset1VersNotes: Literal;
    
    concreteDataset2: CatalogRecord2;
    dataset2Relation: DatasetRelationEnum = this.datasetRelationOpts[0].id;
    dataset2VersInfo: string;
    dataset2VersNotes: Literal;


    constructor(public activeModal: NgbActiveModal, private metadataRegistryService: MetadataRegistryServices, private projectService: ProjectsServices, 
        private basicModals: BasicModalsServices, private translate: TranslateService) {}
    ...
    private createConcreteDataset(): Observable<IRI> {
    ...
    private spawnAbstractDataset(): Observable<IRI> {
